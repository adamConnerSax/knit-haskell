...
knitHtmls
  :: forall
   ...
   . (  forall a
   . P.Semantic r a
  -> P.Semantic (KnitEffectsMany PA.PandocIO) a
  ) -- ^ run any other effects.  Could be @id@.
